...
MIPS ARC Classic processors are represented by three generations of Instruction Set Architectures (ISA).
...
1. ARCompact ISA (also known as ARCv1 ISA):
    ...
    * [ARC 600 Processor Family of 32-bit cores](https://mips.com/processor-solutions/arc-600-family/)
    * [ARC 700 Processor Family of 32-bit cores](https://mips.com/processor-solutions/arc-700-family/)

2. ARCv2 ISA:

    * [ARC EM Processor Family of 32-bit cores](https://mips.com/processor-solutions/arc-classic-processors/arc-em-family/)
    * [ARC HS Processor Family of 32-bit cores (HS3x, HS4x, HS4xD)](https://mips.com/processor-solutions/arc-classic-processors/arc-hs-family/)

3. ARCv3 ISA:

    * [ARC HS Processor Family of 32-bit cores (HS5x, HS5xD)](https://mips.com/processor-solutions/arc-classic-processors/arc-hs5x-processors/)
    * [ARC HS Processor Family of 64-bit cores (HS6x)](https://mips.com/processor-solutions/arc-classic-processors/arc-hs6x-processors/)

4. [ARC VPX DSP Processors](https://mips.com/processor-solutions/arc-vpx-dsp-family/) (not supported by GNU toolchain)

5. [ARC NPX Neural Processing Unit](https://mips.com/processor-solutions/arc-npx-family/) (not supported by GNU toolchain)

You can find programmer's reference manuals and datasheets for each core on corresponding web pages.

## ARC-V

The MIPS ARC-V processors leverage the proven microarchitecture of the
existing ARC processor offerings, while giving customers access to the
expanding RISC-V ecosystem. The MIPS ARC-V portfolio, based on the
...
More information is available on the [MIPS ARC-V webpage](https://mips.com/processor-solutions/arc-v-processors/).
